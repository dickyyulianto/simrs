...
<div class="modal fade" id="cetakModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times; </button>
                <h4 class="modal-title" id="myModalLabel"> <i class="glyphicon glyphicon-edit"></i> Cetak Data Tarif</h4>
            </div>
...
<script type="text/javascript">
    $("#cetak").click(function () {
        $.ajax({
            type: "POST",
            url: "admin/aksi_cetak_tarif_ri.php",
            data: $('form#cetak_tarif_ri').serialize(),
            success: function (msg) {
            ...
            error: function () {
                alert("Gagal mencetak data tarif ");
            }
        });
    });
</script>
