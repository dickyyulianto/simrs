                ...
                <form name="edit_prj" id="edit_prj" method="POST" action="Kasir/aksi_ubah_prj.php">
                    ...
                    <div class="input-group input-lg">
                        <span class="input-group-addon">
                            Nama <i class="glyphicon glyphicon-user"> </i>
                        </span>
                    ...
                    <div class="input-group input-lg ">
                        ...
                        <span class="input-group-addon">
                            Departement <i class="fa fa-hospital-o fa-lg"></i>
                        </span>
                    ...
                    <div class="input-group input-lg">
                        <span class="input-group-addon">Harga Obat (Rp)</span>
                        <input type="text" id="biaya" value="<?php echo $row['harga_resep']; ?>" name="biaya" placeholder="Biaya" class="form-control input-lg" value="" readonly required />
                        <span class="input-group-addon">,-</span>
                    </div>
                    <div class="input-group input-lg">
                        <span class="input-group-addon">Total Biaya (Rp)</span>
                        <input type="text" id="biaya" value="<?php echo $row['harga_resep'] + $row['biaya']; ?>" name="biaya" placeholder="Biaya" class="form-control input-lg" value="" readonly required />
                        <span class="input-group-addon">,-</span>
                    </div>
                    <div class="input-group input-lg">
