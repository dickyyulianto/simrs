<div align="center">
    <h1><label class="label label-info">Data Resep Pasien </label></h1>
    <br>
<!--    <button class="btn btn-primary btn-large" data-toggle="modal" data-target="#tambahModal">-->
<!--        <i class="glyphicon glyphicon-plus-sign"></i> Tambah Harga Resep Pasien-->
<!--    </button>-->
</div>
<br>
...
if (mysqli_num_rows($resultselect)) {
    ...
    while ($row = mysqli_fetch_array($resultselect)) {
        ...
        <tr>
            ...
            <td><?php echo "<a class='btn btn-info btn-sm' href='apoteker.php?view=tampil_ubah_prj&no_rj=" . $row['no_rj'] . "'><i class='glyphicon glyphicon-edit'></i></a>";?></td>
...
<!--                <h4 class="modal-title" id="myModalLabel"> <i class="glyphicon glyphicon-edit"></i> Tambah Harga Resep Pasien </h4>-->
<!--            </div>-->
